...
final Map<String, WordCategory> wordCategories = {
  ...
  'marques': WordCategory(
    ...
    words: const [
      ...
      WordWithDifficulty('William Saurin', difficulty: 2),
      ...
      WordWithDifficulty('BN', difficulty: 3),
